...
// invoice_date (ЭСФ) и delivery_note_date (накладная, добавлено 14 сен 2026,
// §8 хендовера) — оба ISO-даты, просто разные ключи по типу документа.
const DATE_KEYS = new Set(['invoice_date', 'delivery_note_date']);
...
module.exports = { buildEsfDoc, buildNakladnayaDoc };
