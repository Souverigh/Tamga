...
function buildAccountingWorkbook(documents) {
  ...
  documents.forEach((doc, index) => {
    ...
    const number = fieldValue(header, 'invoice_number') || fieldValue(header, 'delivery_note_number') || fieldValue(header, 'act_number');
    const date = fieldValue(header, 'invoice_date') || fieldValue(header, 'delivery_note_date') || fieldValue(header, 'act_date');
    const seller = fieldValue(header, 'seller_name') || fieldValue(header, 'supplier_name') || fieldValue(header, 'contractor_name');
    const sellerInn = fieldValue(header, 'seller_inn') || fieldValue(header, 'supplier_inn') || fieldValue(header, 'contractor_inn');
