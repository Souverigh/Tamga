...
async function recognizeDocument({ base64, mimeType, docType, skipOcr, clientApiKey, clientSlug }) {
  ...
  const { instruction, schemaProperties, requiredFields, skipClassification, tableMode } = buildInstructionAndSchema(docType, { skipOcr, customFields, customDocTypes, formatting, fieldOverrides });
