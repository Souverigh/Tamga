...
async function recognizeDocument({ base64, mimeType, docType, includeText, clientApiKey, clientSlug, clientIp, batchId }) {
  ...
  const { instruction, schemaProperties, requiredFields, skipClassification, tableMode, tableColumns, omitText } = buildInstructionAndSchema(docType, { includeText, customFields, customDocTypes, formatting, fieldOverrides });
