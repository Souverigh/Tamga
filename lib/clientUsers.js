...
const SELECT_COLUMNS = 'id,client_slug,username,password_hash,role,translator_name,created_at,updated_at';
...
// updates — { passwordHash?, role?, translatorName? }, только переданные
// ключи меняются (частичное обновление).
...
module.exports = {
  hasClientUsers, getClientUser, listClientUsers, countOwners,
