...
// полноценной бесплатной заменой платного пакета. Переопределяется
// TAMGA_FREE_DAILY_PAGE_LIMIT в Vercel, если когда-то понадобится другое
// число без переразвёртывания — эта константа лишь запасной вариант, если
