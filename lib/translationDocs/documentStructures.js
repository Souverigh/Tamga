...
const FIELD_DEFINITIONS = {
  ...
  seal: {
    label: 'Печать',
    kind: 'seal',
    hint: 'If a graphical stamp/seal (ink or embossed) is visible anywhere on the document, set the value to exactly "[seal]" — do not attempt to transcribe or describe it. If genuinely no stamp/seal is present, leave the value empty.'
  },
  signature: {
    label: 'Подпись',
    kind: 'signature',
...
const STANDARD_TRANSLATION_FIELDS = {
  ...
  'Свидетельство о рождении': ['country', 'documentNumber', 'fullName', 'taxId', 'birthDate', 'birthPlace', 'recordNumber', 'recordDate', 'fatherName', 'fatherPin', 'fatherCitizenship', 'fatherNationality', 'motherName', 'motherPin', 'motherCitizenship', 'motherNationality', 'issuingAuthority', 'issueDate', 'responsibleEmployee', 'seal', 'signature', 'qrCode'],
  'Свидетельство о браке': ['spouseName', 'spouseFemaleName', 'marriageDate', 'marriagePlace', 'previousSurname', 'recordNumber', 'issueDate', 'seal', 'signature'],
  'Свидетельство о расторжении брака': ['fullName', 'marriageDate', 'recordNumber', 'issueDate', 'issuingAuthority', 'seal', 'signature'],
  // Расширено с общей заглушки до реальной структуры бюро (Ethan, 19 сен
  ...
  'Свидетельство о смерти': ['country', 'documentNumber', 'fullName', 'taxId', 'birthDate', 'birthPlace', 'citizenship', 'deathDate', 'deathPlace', 'recordNumber', 'recordDate', 'issuingAuthority', 'issueDate', 'responsibleEmployee', 'seal', 'signature', 'qrCode'],
  ...
  'Справка о несудимости': ['country', 'fullName', 'taxId', 'certificateStatus', 'identificationCode', 'issuanceNote', 'issuingAuthority', 'contactNote', 'documentNumber', 'formationDateTime', 'sourceSystemNote', 'legalValidityNote', 'actualityNote', 'formedByAuthority', 'signatureDate', 'signatureCode', 'qrCode'],
  'Аттестат': ['country', 'documentType', 'fullName', 'birthDate', 'birthPlace', 'institution', 'locality', 'graduationYear', 'documentNumber', 'issueDate', 'registrationNumber', 'educationLanguage', 'director', 'deputyDirector', 'classTeacher', 'seal', 'signature', 'verificationUrl', 'subjectsAndGrades', 'finalExamsAndGrades'],
  'Диплом / аттестат': ['fullName', 'institution', 'documentNumber', 'issueDate', 'seal', 'signature'],
  'Справка': ['documentType', 'fullName', 'birthDate', 'issueDate', 'issuingAuthority', 'seal', 'signature'],
  'Договор': ['documentType', 'documentNumber', 'date', 'partyOne', 'partyTwo', 'subject', 'amount', 'validityPeriod'],
  'Доверенность': ['fullName', 'documentNumber', 'powers', 'issueDate', 'expiryDate', 'issuingAuthority', 'seal', 'signature'],
