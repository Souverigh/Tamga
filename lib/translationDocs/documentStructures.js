...
const FIELD_DEFINITIONS = {
  ...
  pageSerialNumber: { label: 'Серийный номер страницы' },
...
const STANDARD_TRANSLATION_FIELDS = {
  ...
  'Свидетельство о рождении': ['country', 'documentNumber', 'fullName', 'taxId', 'birthDate', 'birthPlace', 'recordNumber', 'recordDate', 'fatherName', 'fatherPin', 'fatherCitizenship', 'fatherNationality', 'motherName', 'motherPin', 'motherCitizenship', 'motherNationality', 'issuingAuthority', 'issueDate', 'responsibleEmployee', 'seal'],
  ...
  'Свидетельство о смерти': ['country', 'documentNumber', 'fullName', 'taxId', 'birthDate', 'birthPlace', 'citizenship', 'deathDate', 'deathPlace', 'recordNumber', 'recordDate', 'issuingAuthority', 'issueDate', 'responsibleEmployee', 'seal'],
  ...
  // см. noCriminalRecordDocx.mjs.
  'Справка о несудимости': ['country', 'fullName', 'taxId', 'certificateStatus', 'identificationCode', 'issuanceNote', 'issuingAuthority', 'contactNote', 'documentNumber', 'formationDateTime', 'sourceSystemNote', 'legalValidityNote', 'actualityNote', 'formedByAuthority', 'signatureDate', 'signatureCode'],
