...
const STANDARD_TRANSLATION_FIELDS = {
  'Паспорт / удостоверение личности': ['fullName', 'birthDate', 'gender', 'citizenship', 'documentNumber', 'taxId', 'issueDate', 'expiryDate', 'issuingAuthority'],
  ...
  'Аттестат': ['documentType', 'fullName', 'birthDate', 'birthPlace', 'institution', 'locality', 'graduationYear', 'documentNumber', 'issueDate', 'registrationNumber', 'educationLanguage', 'director', 'deputyDirector', 'classTeacher', 'seal', 'verificationUrl', 'subjectsAndGrades', 'finalExamsAndGrades'],
...
const TYPE_REGISTRY = Object.fromEntries([
  ...
  ...DOC_TYPES.map(label => [label, {
    ...
    preservesParagraphs: label === 'Другое' || label === 'Аттестат',
    ...(label === 'Аттестат' ? {
      layout: {
        sections: [
