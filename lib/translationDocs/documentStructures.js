...
const STANDARD_TRANSLATION_FIELDS = {
  ...
  'Аттестат': ['documentType', 'fullName', 'birthDate', 'institution', 'locality', 'graduationYear', 'documentNumber', 'issueDate', 'registrationNumber', 'educationLanguage', 'director', 'deputyDirector', 'classTeacher', 'seal', 'verificationUrl', 'subjectsAndGrades', 'finalExamsAndGrades'],
