...
const FIELD_LABEL_TRANSLATIONS = {
  ...
  ,'Национальность': { en: 'Ethnicity', zh: '民族', de: 'Volkszugehörigkeit', tr: 'Milliyet (etnik köken)', uz: 'Millati', kk: 'Ұлты', ky: 'Улуту', ru: 'Национальность' }
  ,'Семейное положение': { en: 'Marital status', zh: '婚姻状况', de: 'Familienstand', tr: 'Medeni durum', uz: 'Oilaviy holati', kk: 'Отбасылық жағдайы', ky: 'Үй-бүлөлүк абалы', ru: 'Семейное положение' }
  ,'ПИН (ИНН)': { en: 'Personal ID number (PIN)', zh: '个人识别号（PIN）', de: 'Persönliche Identifikationsnummer (PIN)', tr: 'Kişisel kimlik numarası (PIN)', uz: 'Shaxsiy identifikatsiya raqami (PIN)', kk: 'Жеке сәйкестендіру нөмірі (ЖСН)', ky: 'Жеке номер (ПИН)', ru: 'ПИН (ИНН)' }
  ,'Адрес': { en: 'Address', zh: '地址', de: 'Adresse', tr: 'Adres', uz: 'Manzil', kk: 'Мекенжай', ky: 'Дареги', ru: 'Адрес' }
  ,'Фамилия': { en: 'Surname', zh: '姓', de: 'Familienname', tr: 'Soyadı', uz: 'Familiyasi', kk: 'Тегі', ky: 'Фамилиясы', ru: 'Фамилия' }
  ,'Имя': { en: 'Given name', zh: '名', de: 'Vorname', tr: 'Adı', uz: 'Ismi', kk: 'Аты', ky: 'Аты', ru: 'Имя' }
  ,'Отчество': { en: 'Patronymic', zh: '父称', de: 'Vatersname', tr: 'Baba adı', uz: 'Otasining ismi', kk: 'Әкесінің аты', ky: 'Атасынын аты', ru: 'Отчество' }
  ...
  ,'Тип': { en: 'Type', zh: '类型', de: 'Typ', tr: 'Tür', uz: 'Turi', kk: 'Түрі', ky: 'Түрү', ru: 'Тип' }
  ,'Код': { en: 'Code', zh: '代码', de: 'Code', tr: 'Kod', uz: 'Kodi', kk: 'Коды', ky: 'Коду', ru: 'Код' }
  ,'Номер паспорта': { en: 'Passport No.', zh: '护照号码', de: 'Passnummer', tr: 'Pasaport No.', uz: 'Pasport raqami', kk: 'Паспорт нөмірі', ky: 'Паспорт номери', ru: 'Номер паспорта' }
  ,'Оговорки и ограничения': { en: 'Observations and Restrictions', zh: '备注和限制', de: 'Vorbehalte und Einschränkungen', tr: 'Şerhler ve Kısıtlamalar', uz: 'Eslatmalar va cheklovlar', kk: 'Ескертпелер мен шектеулер', ky: 'Эскертүүлөр жана чектөөлөр', ru: 'Оговорки и ограничения' }
  ,'Серийный номер страницы': { en: 'Page serial number', zh: '页面编号', de: 'Seiten-Seriennummer', tr: 'Sayfa seri numarası', uz: 'Sahifa seriya raqami', kk: 'Бет сериялық нөмірі', ky: 'Барактын сериялык номери', ru: 'Серийный номер страницы' }
  ...
  ,'Номер записи': { en: 'Entry No.', zh: '登记号', de: 'Eintragsnummer', tr: 'Kayıt No.', uz: 'Yozuv raqami', kk: 'Жазба нөмірі', ky: 'Жазуу номери', ru: 'Номер записи' }
  ,'Дата составления записи': { en: 'Date of entry', zh: '登记日期', de: 'Datum der Eintragung', tr: 'Kayıt tarihi', uz: 'Yozuv sanasi', kk: 'Жазба жасалған күні', ky: 'Жазуу түзүлгөн күнү', ru: 'Дата составления записи' }
  ,'ФИО отца': { en: "Father's full name", zh: '父亲姓名', de: 'Vollständiger Name des Vaters', tr: 'Baba adı soyadı', uz: 'Otasining F.I.Sh.', kk: 'Әкесінің Т.А.Ә.', ky: 'Атасынын аты-жөнү', ru: 'ФИО отца' }
  ,'ПИН отца': { en: "Father's PIN", zh: '父亲个人识别号', de: 'PIN des Vaters', tr: 'Baba PIN', uz: 'Otasining PIN raqami', kk: 'Әкесінің ЖСН', ky: 'Атасынын ПИН номери', ru: 'ПИН отца' }
  ,'Гражданство отца': { en: "Father's citizenship", zh: '父亲国籍', de: 'Staatsangehörigkeit des Vaters', tr: 'Baba vatandaşlığı', uz: 'Otasining fuqaroligi', kk: 'Әкесінің азаматтығы', ky: 'Атасынын жарандыгы', ru: 'Гражданство отца' }
  ,'Национальность отца': { en: "Father's ethnicity", zh: '父亲民族', de: 'Volkszugehörigkeit des Vaters', tr: 'Baba milliyeti', uz: 'Otasining millati', kk: 'Әкесінің ұлты', ky: 'Атасынын улуту', ru: 'Национальность отца' }
  ,'ФИО матери': { en: "Mother's full name", zh: '母亲姓名', de: 'Vollständiger Name der Mutter', tr: 'Anne adı soyadı', uz: 'Onasining F.I.Sh.', kk: 'Анасының Т.А.Ә.', ky: 'Энесинин аты-жөнү', ru: 'ФИО матери' }
  ,'ПИН матери': { en: "Mother's PIN", zh: '母亲个人识别号', de: 'PIN der Mutter', tr: 'Anne PIN', uz: 'Onasining PIN raqami', kk: 'Анасының ЖСН', ky: 'Энесинин ПИН номери', ru: 'ПИН матери' }
  ,'Гражданство матери': { en: "Mother's citizenship", zh: '母亲国籍', de: 'Staatsangehörigkeit der Mutter', tr: 'Anne vatandaşlığı', uz: 'Onasining fuqaroligi', kk: 'Анасының азаматтығы', ky: 'Энесинин жарандыгы', ru: 'Гражданство матери' }
  ,'Национальность матери': { en: "Mother's ethnicity", zh: '母亲民族', de: 'Volkszugehörigkeit der Mutter', tr: 'Anne milliyeti', uz: 'Onasining millati', kk: 'Анасының ұлты', ky: 'Энесинин улуту', ru: 'Национальность матери' }
  ...
  ,'Дата смерти': { en: 'Date of death', zh: '死亡日期', de: 'Sterbedatum', tr: 'Ölüm tarihi', uz: "Vafot etgan sana", kk: 'Қайтыс болған күні', ky: 'Көз жумган күнү', ru: 'Дата смерти' }
  ,'Место смерти': { en: 'Place of death', zh: '死亡地点', de: 'Sterbeort', tr: 'Ölüm yeri', uz: "Vafot etgan joyi", kk: 'Қайтыс болған жері', ky: 'Көз жумган жери', ru: 'Место смерти' }
  // Поля "Справки о несудимости" (documentStructures.js, 19 сен 2026,
  // портал "Тундук") — нигде в других типах не встречаются.
  ,'Результат (статус)': { en: 'Result (status)', zh: '结果（状态）', de: 'Ergebnis (Status)', tr: 'Sonuç (durum)', uz: 'Natija (holat)', kk: 'Нәтиже (мәртебе)', ky: 'Жыйынтык (абал)', ru: 'Результат (статус)' }
  ,'Идентификационный код': { en: 'Identification code', zh: '识别码', de: 'Identifikationscode', tr: 'Tanımlama kodu', uz: 'Identifikatsiya kodi', kk: 'Идентификациялық код', ky: 'Идентификациялык код', ru: 'Идентификационный код' }
  ,'Примечание об актуальности на дату выдачи': { en: 'Note on validity as of the issuance date', zh: '截至签发之日有效性说明', de: 'Hinweis zur Gültigkeit zum Ausstellungsdatum', tr: 'Düzenleme tarihi itibarıyla geçerlilik notu', uz: 'Berilgan sanaga nisbatan dolzarblik haqida eslatma', kk: 'Берілген күнге өзектілігі туралы ескертпе', ky: 'Берилген күнгө актуалдуулугу жөнүндө эскертүү', ru: 'Примечание об актуальности на дату выдачи' }
  ,'Контакты для вопросов': { en: 'Contact for inquiries', zh: '咨询联系方式', de: 'Kontakt für Rückfragen', tr: 'Sorularınız için iletişim', uz: 'Savollar uchun aloqa', kk: 'Сұрақтар бойынша байланыс', ky: 'Суроолор боюнча байланыш', ru: 'Контакты для вопросов' }
  ,'Дата и время формирования документа': { en: 'Document formation date and time', zh: '文件生成日期和时间', de: 'Datum und Uhrzeit der Dokumenterstellung', tr: 'Belge oluşturma tarihi ve saati', uz: 'Hujjat shakllantirilgan sana va vaqt', kk: 'Құжат қалыптастырылған күні мен уақыты', ky: 'Документ түзүлгөн күнү жана убактысы', ru: 'Дата и время формирования документа' }
  ,'Примечание об источнике данных': { en: 'Note on data source', zh: '数据来源说明', de: 'Hinweis zur Datenquelle', tr: 'Veri kaynağı hakkında not', uz: 'Ma’lumot manbai haqida eslatma', kk: 'Дерек көзі туралы ескертпе', ky: 'Дайын булагы жөнүндө эскертүү', ru: 'Примечание об источнике данных' }
  ,'Примечание о юридической силе документа': { en: 'Note on the legal validity of the document', zh: '文件法律效力说明', de: 'Hinweis zur Rechtsgültigkeit des Dokuments', tr: 'Belgenin hukuki geçerliliği hakkında not', uz: 'Hujjatning yuridik kuchi haqida eslatma', kk: 'Құжаттың заңды күші туралы ескертпе', ky: 'Документтин юридикалык күчү жөнүндө эскертүү', ru: 'Примечание о юридической силе документа' }
  ,'Примечание об актуальности данных': { en: 'Note on data relevance', zh: '数据时效性说明', de: 'Hinweis zur Aktualität der Daten', tr: 'Verilerin güncelliği hakkında not', uz: 'Ma’lumotlarning dolzarbligi haqida eslatma', kk: 'Деректердің өзектілігі туралы ескертпе', ky: 'Дайындардын актуалдуулугу жөнүндө эскертүү', ru: 'Примечание об актуальности данных' }
  ,'Документ сформирован': { en: 'Document formed by', zh: '文件生成机构', de: 'Dokument erstellt von', tr: 'Belgeyi oluşturan', uz: 'Hujjatni shakllantirgan', kk: 'Құжатты қалыптастырған', ky: 'Документти түзгөн', ru: 'Документ сформирован' }
  ,'Дата подписи': { en: 'Signature date', zh: '签名日期', de: 'Unterschriftsdatum', tr: 'İmza tarihi', uz: 'Imzo sanasi', kk: 'Қол қою күні', ky: 'Кол коюлган күнү', ru: 'Дата подписи' }
  ,'Код подписи': { en: 'Signature code', zh: '签名代码', de: 'Signaturcode', tr: 'İmza kodu', uz: 'Imzo kodi', kk: 'Қол қою коды', ky: 'Кол тамга коду', ru: 'Код подписи' }
  ...
  // уже есть выше.
  ,'Количество членов семьи': { en: 'Number of family members', zh: '家庭成员人数', de: 'Anzahl der Familienmitglieder', tr: 'Aile üyesi sayısı', uz: 'Oila a’zolari soni', kk: 'Отбасы мүшелерінің саны', ky: 'Үй-бүлө мүчөлөрүнүн саны', ru: 'Количество членов семьи' }
};
