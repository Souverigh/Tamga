...
//
// "confidence" — самооценка модели (целое число 0-100), насколько она уверена,
// что текст/поля/строки таблицы извлечены с этого изображения полно и верно.
// Это self-reported оценка самой Gemini в том же ответе, а не статистическая
// вероятность — полезный сигнал, чтобы отсортировать пачку и в первую очередь
// перепроверить документы с низким числом, но не гарантия правильности/ошибки.
// null, если модель не смогла дать оценку (см. lib/fieldFormat.js:normalizeConfidence).
//
