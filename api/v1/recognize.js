...
//
// "warnings" (Ethan, 10 сен 2026) — [{ level: "error"|"info", message }, ...],
// результат проверки бизнес-правил, настроенных для вашего x-api-key через
// /admin (например, "Сумма НДС ≈ 12% от Суммы без НДС", "Дата окончания не
// раньше Даты выдачи") — та же проверка, что видит пользователь веб-интерфейса,
// теперь применяется одинаково и здесь. Пустой массив, если правил не
// настроено или замечаний не нашлось — НЕ признак ошибки запроса.
//
