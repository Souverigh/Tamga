...
export async function extractStructuralParagraphs(file) {
  ...
  if (!paragraphs.length) {
    throw new Error('В документе не найдено переводимого текста — возможно, это скан, вставленный как картинка. Снимите галочку "Перевести как есть" — обычное распознавание умеет доставать картинку из .docx.');
  }
